    ...
    <header className="flex-none flex items-center justify-between gap-2 sm:gap-4 p-2 sm:p-4 border-b border-border bg-background z-10">
      <div className="flex items-center gap-2">
        {!disableSidebarButton ? (
          ...
          <PanelRightClose className="w-5 h-5 mr-2 opacity-50 cursor-not-allowed" />
        )}
        <Link href="/">
        ...
        {!disableModelSelection ? (
          <div className="relative min-w-[120px] sm:min-w-[140px]">
            <DropdownMenu>
              <DropdownMenuTrigger
                className={cn(
                  "w-full flex items-center gap-2 bg-transparent border border-input rounded-md px-2 py-1 text-sm focus:outline-none",
          ...
          <div
            className={cn(
              "w-full flex items-center gap-2 bg-transparent border border-input rounded-md px-2 py-1 text-sm opacity-50 cursor-not-allowed pointer-events-none",
